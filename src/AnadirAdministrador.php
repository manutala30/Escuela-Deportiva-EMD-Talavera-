...
echo '
        ...
        <div class="formulario">
            <h2>Crea tu Cuenta Administrador</h2>
            <form action="#" method="post">
                ...
                <input type="password" placeholder="Contraseña" name="pass" id="pass" onblur="Validacionpass()" required>
                <i id="comp1" hidden STYLE="color: red; font-size: 0.8em; margin: 0">Las contraseñas no coinciden</i>
                <input type="password" placeholder=" Repite tu Contraseña" name="pass2"  id="pass1" required onblur="Validacionpass()">
...
if (isset($_POST["enviar1"]))
{
   /*Verifica que las dos contraseñas sean iguales*/
    if ($_POST["pass"]==$_POST["pass2"]) {
        /*Consulta para añadir un administrador*/
        ...
        $insertarUsuario = "INSERT INTO usuarios(Nombre,Apellidos,NombreUsuario,Password,Correo,Preguntaseg,Respuesta,Tipo) VALUES 
                                        ...
                                        ,'" . $contrasenahash . "','" . $_POST["mail"] . "','" . $_POST["pre"] . "','" . $_POST["res"] . "','a');";
        ...
        if ($objconexion->comprobar() > 0) {
            ...
            icon:"success",
            text:"Registro del administrador completado",
            ...
            if (result.isConfirmed) {
                window.top.location="AñadirAdministrador.php";
            }
        })
          </script>';
        }
        ...
        echo '<script>
            ...
            if (result.isConfirmed) {
                window.top.location="AnadirAdministrador.php";
            }
        })
          </script>';
    }
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script>
    /*Comprobamos si las contraseñas introducidas coinciden*/
