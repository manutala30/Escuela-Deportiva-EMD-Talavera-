...
<head>
    ...
    <title>EMD TALAVERA- Reserva FS</title>
...
<div class="row">
    <div class="col-md-4 text-center">
        <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="imagenes/futbolsal.PNG" alt=""
    ...
    <div class="col-md-7">
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                <tr class="text-center">
                    <td>Pista Exterior</td>
                    <td>10.00€</td>
                    <td>20.00€</td>
                </tr>
                <tr class="text-center">
                    <td>Pista Interior</td>
                    <td>10.00€</td>
                    <td>20.00€</td>
                </tr>
        ...
        <h3 class="text-center">Reserva tu pista de Fútbol Sala</h3>
        ';
                if (!isset($_SESSION["id"])) {
                    echo '
        ...
        <form  action="ReservasFinal.php" method="GET">
            <div class="col-md-12 text-center">
                ...
                <input type="text" value="11" name="deporte" hidden>
                <input type="text" id="datepicker" name="fecha" required>
                <label for="pista"><h5>Campo :</h5></label>
                ';
                    /*Buscamos las pistas del deporte seleccionado*/
                    $consulta = 'SELECT * FROM `pistas` WHERE idDeporte=11';
