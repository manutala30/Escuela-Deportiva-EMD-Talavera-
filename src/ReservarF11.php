...
<head>
    ...
    <title>EMD TALAVERA- Reserva F11</title>
    ...
    if(!isset($_POST["enviar"])) {
        echo '
                    ...
                    <div class="col-md-4 text-center">
                      <a href="#">
                        <img class="img-fluid rounded mb-3 mb-md-0" src="imagenes/cesped.png" alt=""
           ...
           <table class="table table-hover table-bordered">
            ...
            <tbody>
                <tr class="text-center">
                    <td>Campo de Cesped</td>
                    <td>15.00€</td>
                    <td>25.00€</td>
                </tr>
                <tr class="text-center">
                     <td>Campo de Tierra</td>
                     <td>10.00€</td>
                     <td>15.00€</td>
				</tr>				
			</tbody>
		</table>
                      <h3 class="text-center">Reserva tu pista Campo de Fútbol 11</h3>
                      ';
        if (!isset($_SESSION["id"])) {
            echo '
        ...
        ';
            ...
            echo '
                      ...
                      <div class="col-md-12 text-center">
                                ...
                                <input type="text" value="1" name="deporte" hidden>
                                <label for="pista"><h5>Campo :</h5></label>
                        ';
            $consulta = 'SELECT * FROM `pistas` WHERE idDeporte=1';
