...
<head>
    ...
    <title>EMD TALAVERA- Reserva F7</title>
...
<div class="row">
    <div class="col-md-4 text-center">
        <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="imagenes/Futbol7.PNG" alt=""
    ...
    <div class="col-md-7">
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                <tr class="text-center">
                    <td>Campo de Albero</td>
                    <td>8.00€</td>
                    <td>12.00€</td>
                </tr>
            </tbody>
        </table>
        <h3 class="text-center">Reserva tu pista Campo de Fútbol 7</h3>
        ';
                if (!isset($_SESSION["id"])) {
                    echo '
        ...
        <form  action="ReservasFinal.php" method="GET">
            <div class="col-md-12 text-center">
                ...
                <input type="text" value="12" name="deporte" hidden>
                <label for="pista"><h5>Campo :</h5></label>
                ';
                    $consulta = 'SELECT * FROM `pistas` WHERE idDeporte=12';
