...
<head>
    ...
    <title>EMD TALAVERA- Reserva Tenis</title>
...
<div class="row">
    <div class="col-md-4 text-center">
        <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="imagenes/tenis.png" alt=""
    ...
    <div class="col-md-7">
        ...
        <h3 class="text-center">Reserva tu pista de Tenis</h3>';
                if (!isset($_SESSION["id"])) {
                    echo '
        ...
        <form  action="ReservasFinal.php" method="GET">
            <div class="col-md-12 text-center">
                ...
                <input type="text" value="2" name="deporte" hidden>
                <label for="pista"><h5>Campo :</h5></label>
                ';
                    /*
                     * Consulta para ver las pistas del deporte seleccionado
                     */
                    $consulta = 'SELECT * FROM `pistas` WHERE idDeporte=2';
