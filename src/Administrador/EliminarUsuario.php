...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
         ...
         <form method="post" class="text-center">
           <p><h3>¿Realmente desea eliminar el Usuario?</h3></p>
              <input type="radio" name="check" value="si" >
              <label for="no">Si,eliminar Usuario</label><br>
              <input type="radio"name="check1" value="no">
              <label for="no">No,eliminar Usuario</label><br><br>
    ...
    /*Comprobamos la repuesta seleccionadda*/
    if (isset($_POST["check"])) {
        ...
        if ($objconexion->comprobar() > 0) {
            ...
            if (result.isConfirmed) {
                window.top.location="VerUsuarios.php";
            }
        })
          </script>';
        }
    ...
    if (isset($_POST["check1"])) {
        {
            ...
            icon:"error",
            text:"Usuario no eliminado con éxito",
            allowOutsideClick: false,
            allowEscapeKey: false,
            allowEnterKey: false,
            stopKeydownPropagation:false,
